...
style=numeric, 		 			% Zitierstil (numeric, alphabetic, authoryear-icomp, authortitle, verbose, authoryear-ibid, apa, etc.)
natbib=true, 						% Bereitstellen von natbib-kompatiblen Zitierkommandos
autocite=inline, 	   			% regelt Aussehen für autocite (inline, footnote)
